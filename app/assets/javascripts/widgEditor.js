...
widgSelectBlockOptions.push("", "Bytt skrift type");
widgSelectBlockOptions.push("<h1>", "Overskrift 1");
widgSelectBlockOptions.push("<h2>", "Overskrift 2");
widgSelectBlockOptions.push("<h3>", "Overskrift 3");
widgSelectBlockOptions.push("<h4>", "Overskrift 4");
widgSelectBlockOptions.push("<h5>", "Overskrift 5");
widgSelectBlockOptions.push("<h6>", "Overskrift 6");
widgSelectBlockOptions.push("<p>", "Vanlig text");

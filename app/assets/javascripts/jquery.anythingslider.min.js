	...
	d.anythingSlider = function(i, k) {
		...
		a.init = function() {
			...
			d(document).keyup(function(c) {
				if (b.enableKeyboard && (a.$wrapper.hasClass("activeSlider") && !c.target.tagName.match("TEXTAREA|INPUT|SELECT")) && !(b.mode !== "vertical" && (c.which === 38 || c.which === 40)))
					switch(c.which) {
						case 39:
						case 40:
							a.goForward();
		...
		a.updateSlider = function() {
			...
			a.$items.find("a").unbind("focus.AnythingSlider").bind("focus.AnythingSlider", function(c) {
				...
				if (-1 !== e && (e >= a.currentPage + b.showMultiple || e < a.currentPage))
		...
		a.setDimensions = function() {
			var c, f, e, g, h = 0, i = {
				width : "100%",
				height : "100%"
			}, l = 1 < b.showMultiple ? a.width || a.$window.width() / b.showMultiple : a.$window.width(), j = a.$win.width();
		...
		a.getDim = function(c) {
			...
			if (1 < b.showMultiple)
				for ( f = 1; f < b.showMultiple; f++)
					e += a.panelSize[c+f][0], d = Math.max(d, a.panelSize[c+f][1]);
			return [e, d]
		};
		...
		a.gotoPage = function(c, f, e, g) {
			...
			if (!(1 >= a.pages) && (a.$lastPage = a.$currentPage, "number" !== typeof c && ( c = parseInt(c, 10) || b.startPanel, a.setCurrentPage(c)), !f || !b.isVideoPlaying(a)))
				a.exactPage = c, c > a.pages + 1 - a.adj && ( c = !b.infiniteSlides && !b.stopAtEnd ? 1 : a.pages), c < a.adj && ( c = !b.infiniteSlides && !b.stopAtEnd ? a.pages : 1), b.infiniteSlides || (a.exactPage = c), a.currentPage = c > a.pages ? a.pages : 1 > c ? 1 : a.currentPage, a.$currentPage = a.$items.eq(a.currentPage - a.adj), a.targetPage = 0 === c ? a.pages : c > a.pages ? 1 : c, a.$targetPage = a.$items.eq(a.targetPage - a.adj), g = "undefined" !== typeof g ? g : b.animationTime, 0 <= g && a.$el.trigger("slide_init", a), 0 < g && a.slideControls(!0), b.buildNavigation && a.setNavigation(a.targetPage), !0 !== f && ( f = !1), (!f || b.stopAtEnd && c === a.pages) && a.startStop(!1), 0 <= g && a.$el.trigger("slide_begin", a), setTimeout(function(d) {
					var f, h = true;
		...
		a.fadeIt = function(a, d, e, g) {
			...
			if (b.resumeOnVisible)
				a.filter(":not(:animated)").fadeTo(e, d, g);
			else
				a.filter(":not(:animated)")[0===d?"fadeOut":"fadeIn"](e, g)
		};
